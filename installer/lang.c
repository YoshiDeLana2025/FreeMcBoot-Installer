static const char *DefaultLanguageStringTable[SYS_UI_MSG_COUNT] = {
    ...
    "YoshiBoot Autoboot will be installed onto the memory card in slot 1. Continue?",
    "YoshiBoot Autoboot will be installed onto the memory card in slot 2. Continue?",
    "FHDB will be installed onto the Harddisk Drive. Continue?",
    "Install YoshiBoot Autoboot for:",
    "Cache initialization failed.",
    "Existing YoshiBoot Autoboot CNF found!\nDo you want to keep it?",
    "Existing FHDB CNF found!\nDo you want to keep it?",
    "Cleanup failed.",
    "The installation was cleaned up successfully.",
    "Installation failed.",
    "Installation completed.",
    "YoshiBoot Autoboot on the memory card in slot 1 will be cleaned up. Continue?",
    "YoshiBoot Autoboot on the memory card in slot 2 will be cleaned up. Continue?",
    ...
    "Install YoshiBoot Autoboot for this console.",
    "Install YoshiBoot Autoboot for all consoles.",
    "Uninstall YoshiBoot Autoboot.",
    ...
    "Install YoshiBoot Autoboot (PSX) on this memory card.",
    ...
    "This console does not support YoshiBoot Autoboot.\n\nHowever, you can still make installations with it.",
...
static const char *DefaultLanguageLabelStringTable[SYS_UI_LBL_COUNT] = {
    ...
    "Dump MC",
    "Restore MC",
    "Install YoshiBoot Autoboot (PSX)",
    "Install FHDB",
    "Uninstall FHDB",
    "Exit",
    "B",
